...
When contributing to open source project it is polite to follow the original authors coding standards. They might be different than yours. It is not a holy war. This project uses **[GO Style Coding Standard](https://github.com/golang/go/wiki/CodeReviewComments)**
